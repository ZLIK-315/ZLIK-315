...
public class SysUserController extends BaseController{
    ...
    public Result list(Long id,String username,Long deptId,Integer state,Long roleId){
        ...
        Page<SysUser> pageData = sysUserService.page ( getPage (), new QueryWrapper< SysUser > ()
                ...
                .like ( id != null , "id", id )
                .or ()
                .like ( deptId != null ,"dept_Id", deptId)
                .or ()
                .like ( state != null ,"state", state)
        );
        pageData.getRecords ().forEach ( p -> {
            List< SysDept > sysDepts = sysDeptService.listDeptsByUserId ( p.getDeptId () );
            p.setSysDepts (sysDepts );
            List< SysRole > sysRoles = sysRoleService.listRolesByUserId (  p.getId () );
            p.setSysRoles ( sysRoles );
        } );
    ...
    public Result save(@Validated @RequestBody SysUser sysUser) {
        ...
        sysUser.setState( Const.STATE_ON);
